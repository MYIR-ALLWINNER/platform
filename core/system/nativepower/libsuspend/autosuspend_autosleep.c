...
static int autosuspend_autosleep_enable(void)
{
	...
	printf("autosuspend_autosleep_enable\n");
	...
	printf("autosuspend_autosleep_enable done\n");
...
static int autosuspend_autosleep_disable(void)
{
	...
	printf("autosuspend_autosleep_disable\n");
	...
	printf("autosuspend_autosleep_disable done\n");
