...
static void getDiskInfo(struct Disk *disk)
{
	...
	DLOG("MaxCapacity:    %lluM. %lluKB. %llubytes", disk->dMaxCap>>20, disk->dMaxCap>>10, disk->dMaxCap);
	DLOG("FreeSpace: %lluM. %lluKB. %llubytes", disk->dFreeSpace>>20, disk->dFreeSpace>>10, disk->dFreeSpace);
